...
---
## 🔌 Hardware Components
- Microcontroller Unit: ESP32-WROVER-E-N16R8
- Audio Processing: VS1053b
- File Storage: MicroSD_card slot (Molex 502570-0893)
- Display: TFT-LCD Color Display ( NHD-2.4-240320DA-CTXN)
- Power System:
